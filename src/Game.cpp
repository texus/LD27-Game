    ...
    gui(window)
{
    ...
    if (gui.setGlobalFont("assets/gui/DejaVuSans.ttf") == false)
    ...
    cars.emplace(cars.end(), 375, 2.25, "assets/Car2.png");
    cars.emplace(cars.end(), 500, 3, "assets/Car3.png");
...
void Game::runMenuScreen()
{
    ...
    selectCarButton->load("assets/gui/Black.conf");
    ...
    exitButton->load("assets/gui/Black.conf");
...
void Game::runCarSelection()
{
    ...
    for (unsigned int i = 0; i < cars.size(); ++i, ++it)
    {
        ...
        control->load("assets/gui/Black.conf");
        ...
        select->load("assets/gui/Black.conf");
...
void Game::runLevelSelection()
{
    ...
    for (unsigned int i = 0; i < trackNames.size(); ++i)
    {
        ...
        button->load("assets/gui/Black.conf");
...
void Game::runGame()
{
    ...
    catch (std::exception& e)
    {
        ...
        if (message->load("assets/gui/Black.conf") == false)
...
void Game::runGameFailed()
{
    ...
    replayButton->load("assets/gui/Black.conf");
...
{
    std::ifstream file("assets/TrackList.dat");
    if (!file.is_open())
